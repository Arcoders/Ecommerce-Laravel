                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                <h1 class="h1">Recibo de tu pago en Arcoders</h1>
                                                                </br>
                                                                <strong>¡Hola! {{$order->recipient_name}}</strong>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a style="color: #FFFFFF;" href="{{url('/compras/'.$order->shoppingCartID())}}" target="_blank">Más información de mi pedido</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 20{{date('y')}} - ARCODERS, All rights reserved.</em>
																<br />
